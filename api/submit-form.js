...
// Single clean Vercel serverless handler for contact form submissions.
// Expects POST JSON: { name, company?, phone?, email, workflow?: string[]|string, details? }
module.exports = async (req, res) => {
  ...
  // Minimal presence logging for debugging (avoid logging secrets/PII)
